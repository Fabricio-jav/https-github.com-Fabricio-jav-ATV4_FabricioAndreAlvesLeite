...
public class Teste {
	...
	public static void main(String[] args) {
		...
		Vendedor vendedor = new Vendedor("Vanessa", "55666", "F", 6000.99,500.00);
		...
		gerente.setNome("Fabricio andre");
		...
		funcionario.setNome("Laryssa Ferreira");
		funcionario.setSalario(4000.88);
		funcionario1.setNome("Andryella Isabela");
		funcionario1.setSalario(3000.00);
		funcionario2.setNome("Maria Amanda");
		...
		vendedor.setNome("Maria do Nascimento");
